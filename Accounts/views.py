...
def SignupView(request):
    ...
    if request.method == 'POST':
        ...
        if password1 == password2:
            user = User.objects.create_user(email=email,is_active=False, profile="Static/images/user-placeholder.jpg",password=password1, first_name=first_name,last_name=last_name,address=address,phone=phone,dob=dob,gender=gender)
    ...
    def authenticate(request=None, username=None, password=None, **kwargs):
        ...
        try:
            ...
            if user.check_password(password):
                return user
            return render(request, 'home/signin.html', {'results': user})
